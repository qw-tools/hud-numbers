<template>
  <div class="flex text-black h-96 items-center justify-center space-x-2 rounded-md">
    <svg class="animate-spin h-6 w-6 text-sky-600" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
